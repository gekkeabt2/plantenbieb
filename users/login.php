...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	$user = $database->select("users", ['user_active','user_name','user_password','user_mail','user_id'], ["user_mail" => $mail]);
	...
	if (count($user) != 0)
		{
			...
			if ($pass == str_replace(" ", "", $user[0]["user_password"]))
				...
				// Show error if password is incorrect //
				$error = "Je account is nog niet geactiveerd. Klik op wachtwoord vergeten om je wachtwoord te resetten, hierbij wordt je account tegelijk geactiveerd.";	
			}
		}
	  else
		{
...
<div class="row">
 <div class="col-md-12">
	   ...
	   <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
		  ...
		  <p>Heeft u nog geen account? <a href="users/register">Registreer!</a>.</p>
		  <p>Wachtwoord vergeten? <a href="users/pass_reset">Reset uw wachtwoord</a>.</p>
	   </form>
 </div>
</div>
