...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <h1 class="display-4">Registreren
      </h1>
    </div>
  </div>
  <div class="row">
...
echo $mail; ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" name="zip" class="form-control" value="<?php
echo $zip; ?>">
        </div>
        <div class="form-group">
          <label>Wachtwoord
        ...
        <div class="form-group">
          ...
          <textarea name="bio" class="form-control" placeholder="Hier kunt u iets over uzelf vertellen.">
            <?php
echo $bio; ?>
          </textarea>
        </div>
